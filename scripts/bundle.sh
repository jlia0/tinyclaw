...
chmod +x "$BUNDLE_DIR/install/setup-wizard.sh"
chmod +x "$BUNDLE_DIR/install/install.sh"
chmod +x "$BUNDLE_DIR/install/uninstall.sh"
...
echo "  cd test-install && ./install/install.sh"
echo ""
